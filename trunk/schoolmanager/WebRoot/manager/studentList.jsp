<div class="left_content">
	...
	<div class="sidebar_search">
		<form>
			<input type="text" name="" class="search_input"
				...
				type="image" class="search_submit" src="back_css/images/search.png" />
		</form>
	</div>
	...
	<div class="sidebar_box">
		...
		<div class="sidebar_box_content">
			...
			<img src="back_css/images/info.png" alt="" title=""
	...
	<div class="sidebar_box">
		...
		<div class="sidebar_box_content">
			...
			<img src="back_css/images/notice.png" alt="" title=""
				class="sidebar_icon_right" />
			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
				do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
		</div>
	...
	<div class="sidebar_box">
		...
		<div class="sidebar_box_content">
			...
			<img src="back_css/images/photo.png" alt="" title=""
				class="sidebar_icon_right" />
			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
				do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
		</div>
...
<div class="right_content">
	...
	<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
		...
		<tfoot>
			<tr>
				<td colspan="6" class="rounded-foot-left"><em>Lorem ipsum
						dolor sit amet, consectetur adipisicing elit, sed do eiusmod
						tempor incididunt ut.</em></td>
		...
		<tbody>
			<tr>
				...
				<td><a href="#"><img src="back_css/images/user_edit.png"
						alt="" title="" border="0" /> </a></td>
				<td><a href="#" class="ask"><img
						src="back_css/images/trash.png" alt="" title="" border="0" /> </a></td>
			</tr>
	...
	<a href="#" class="bt_green"><span class="bt_green_lft"></span><strong>Add
			new item</strong><span class="bt_green_r"></span> </a> <a href="#" class="bt_blue"><span
		class="bt_blue_lft"></span><strong>View all items from
			category</strong><span class="bt_blue_r"></span> </a> <a href="#" class="bt_red"><span
		class="bt_red_lft"></span><strong>Delete items</strong><span
	...
	<div class="warning_box">Lorem ipsum dolor sit amet, consectetur
		adipisicing elit, sed do eiusmod tempor incididunt ut.</div>
	<div class="valid_box">Lorem ipsum dolor sit amet, consectetur
		adipisicing elit, sed do eiusmod tempor incididunt ut.</div>
	<div class="error_box">Lorem ipsum dolor sit amet, consectetur
		adipisicing elit, sed do eiusmod tempor incididunt ut.</div>
				...
				<dl>
					...
					<dd>
						<input type="checkbox" name="interests[]" id="" value="" /><label
							...
							name="interests[]" id="" value="" /><label class="check_label">Business</label>
						<input type="checkbox" name="interests[]" id="" value="" /><label
							class="check_label">Simple</label> <input type="checkbox"
							name="interests[]" id="" value="" /><label class="check_label">Clean</label>
					</dd>
				</dl>
				...
				<dl>
					...
					<dd>
						<input type="radio" name="type" id="" value="" /><label
							class="check_label">Basic</label> <input type="radio" name="type"
							id="" value="" /><label class="check_label">Medium</label> <input
							type="radio" name="type" id="" value="" /><label
